...
function calculateRevenueModel(assumptions = {}, actuals = {}) {
  ...
  // Cumulative expansion: accounts × ACV × cumulative expansion rates
  ...
  const stream2 = {
    y1: a.active_accounts * (a.avg_acv_today * a.expansion_rate_y1),
    y2: (a.active_accounts + new_logos_y1) * (a.avg_acv_today * (a.expansion_rate_y1 + a.expansion_rate_y2)),
    y3: (a.active_accounts + new_logos_y1 + new_logos_y2) * (a.avg_acv_today * (a.expansion_rate_y1 + a.expansion_rate_y2 + a.expansion_rate_y3)),
  }
